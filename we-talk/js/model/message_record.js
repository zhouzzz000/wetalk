...
class MessageRecord{
	...
	static saveUserMessageHistoryAll(data,myId,friendId)
	{
		if(data == null || data == undefined || data.size < 1)
		{
			return;
		}
		mui.plusReady(()=> {
	...
	static clearUserMessageHistoryAll(myId,friendId)
	{
		mui.plusReady(()=> {
		    var key = "chat-"+ myId + "-" + friendId;
		    // 聊天记录是否已有缓存
