...
mui.plusReady(function() {
	...
	var verifImage = document.getElementById("verify_image");
	verifImage.addEventListener("tap",()=>{
		
		verifImage.src="http://192.168.1.100:8080/wetalk/user/verify_image?random="+Math.random();
	});
