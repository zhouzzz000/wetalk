...
public class UnifyJsonResult {
    ...
    public static UnifyJsonResult ok(Object data) {
        return new UnifyJsonResult(data);
    }

    public static UnifyJsonResult ok() {
    ...
    public static UnifyJsonResult errorMsg(Object data) {
